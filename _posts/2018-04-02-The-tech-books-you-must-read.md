...
### [Designing Data-Intensive Applications](https://amzn.to/3DtzQNt)
...
### [Domain-Driven Design: Tackling Complexity in the Heart of Software](https://amzn.to/3FdbU2i)
...
### [The Lean Startup: How Constant Innovation Creates Radically Successful Businesses](https://amzn.to/3aaVg5i)
...
### [Java Concurrency in Practice](https://amzn.to/2WJAhU1)
...
### [The Manager's Path: A Guide for Tech Leaders navigating growth and change](https://amzn.to/2YrOnKy)
...
### [The Phoenix Project](https://amzn.to/2YsljCD)
...
### [SQL Performance Explained](https://amzn.to/3ljXUMx)
...
### [Computer Networking: A top-down approach](https://amzn.to/2YhRqo8)
...
### [Test-Driven Development: by example](https://amzn.to/3B9suxH)
...
### [Black Box Thinking: Why some people never learn from their mistakes, but some do](https://amzn.to/3DgteSa)
...
### [Real-World Cryptography](https://amzn.to/3uHzBLt)

_The discovery of this book was pure luck personally. Someone from my network liked the announcement for its launch and that ended up in my feed (recommendations algorithm did its job!). Looking at its contents, I knew it would be good, but I was still pleasantly surprised. This book covers many a wide range of topics and all of them are covered in a rather practical way, giving enough foundational knowledge to the reader without overloading them with theory. Instead of just presenting how things work, in several cases the author explains why things don't work in a different way and presents examples from his professional experience with real projects. Even though I had already completed [Coursera's course on Cryptography](https://www.coursera.org/learn/crypto), I still learned a lot of new things. Even though Cryptography might seem like a piece of esoteric knowledge, cryptographic constructs are used in many systems around us. Even though you aren't commonly called to build a new construct, it is still useful to know how you can properly use existing constructs as the devil is in the details and (unfortunately) there are many ways things can go wrong._

<br/>

### [Threat Modeling: Designing for Security](https://amzn.to/360sohn)

_I decided to read this book at a time, when I was getting increasingly involved with building software systems that were security-sensitive. I knew about the concept of threat modelling and I had used it in collaboration with other people in some projects, but I wanted to learn more about it. When I did some research online, I found this is one of the most well known books about threat modelling and the author has been working on the field for many decades evangelising the use of threat modelling. Despite the age of the book, it was a positive revelation. I learned a lot of things, not only about threat modelling, but also about how to build more secure systems. In an era, where more and more systems become critical to our everyday life and a security vulnerability can have serious repercussions, making systems secure cannot be left entirely up to security teams. Software engineers should be able to reason about security and know where they need to engage subject matter experts to avoid introducing subtle vulnerabilities in systems. The book is a bit large, so it requires some determination to finish it, but in the end it's all worth it._

<br/>

### [Kubernetes in Action](https://amzn.to/3smovuy)

_Kubernetes is such a buzzword these days. As expected, the time came when I ended up using it at work too. After some very quick prototyping, I quickly realised how valuable it was in streamlining our automated testing processes. However, I also realised that their documentation could only get me so far. I decided to read a book about Kubernetes to get a better understanding of the various concepts and levers available. I had no regrets for choosing this one, since it was exactly what I was looking for. The author takes you through the various concepts available in a very smooth way. Each concept is introduced via an example, which you can run locally or using a public cloud provider. The author starts from basic concepts, but goes into more advanced concepts. I was able to quickly skim some parts that I was confident I wouldn't need soon enough (hoping I can come back, if needed) and I was still able to follow through thanks to the nice structure of the book. Even if you don't plan to use Kubernetes, my personal opinion is you can still benefit from this book. Many of the concepts and practices presented in the book are applicable more generally and could prove to be useful if you are responsible for operating software systems regardless of the technologies you use._
